...
#define OBF_SC_OBJECT_FORMAT_PE_COFF UINT32_C(2)
#define OBF_SC_MACHINE_X86_64 UINT32_C(1)
#define OBF_SC_TARGET_RECORD_REL64 UINT32_C(1)
#define OBF_SC_TARGET_RECORD_REL32 UINT32_C(2) /* PE/COFF: signed low 32 bits, high 32 bits zero */
...
#define OBF_SC_COFF_SECTION_NAME ".obfsc$M"
#define OBF_SC_PE_SECTION_NAME ".obfsc"
