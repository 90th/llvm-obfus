...
int main(int argc, char** argv) {
  ...
  if (!required_frontend.empty() && required_frontend != "generic" &&
      required_frontend != "rust" && required_frontend != "zig" &&
      required_frontend != "tinygo") {
  ...
  if (!config_path.empty()) {
    ...
    if (!required_frontend.empty() && obf::to_string(config->frontend) != required_frontend) {
