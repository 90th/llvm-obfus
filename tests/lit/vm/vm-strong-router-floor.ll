...
; seed 8080 maps strong_target to a weak raw thunk shape before the strong_vm floor.
; the strong_vm floor must upgrade that thunk to split, indirect, or decoy_indirect.
...
; CHECK: "vm.entry.thunk.shape.{{(split|indirect|decoy_indirect)}}"
