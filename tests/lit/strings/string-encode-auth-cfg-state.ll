...
; CHECK-DAG: call ptr @[[STRHELPER:__obf_[A-Za-z0-9_]+]](ptr {{.*}}, i32 %obf.state, i32 {{-?[0-9]+}}, i64 7, i64 {{-?[0-9]+}}, ptr {{.*}})
; CHECK-DAG: call ptr @[[STRHELPER]](ptr {{.*}}, i32 %obf.state, i32 {{-?[0-9]+}}, i64 7, i64 {{-?[0-9]+}}, ptr {{.*}})
; CHECK: define internal ptr @[[STRHELPER]](ptr %desc, i32 %cfg_state, i32 %expected_state, i64 %trusted_length, i64 %trusted_binding, ptr %trusted_topology) {
...
; CHECK: unreachable
; CHECK: decode:
; CHECK: call ptr @rt_core_sd3(ptr %desc, i64 %trusted_length, i64 %trusted_binding, ptr %trusted_topology)
; CHECK: ret ptr
