...
; RUN: %lli %t
; RUN: %python %S/../Inputs/tamper_string_auth_ir.py %t __obf_string_desc__secret state-ref
; RUN: not --crash %lli %t

@.secret = private unnamed_addr constant [33 x i8] c"secretsecretsecretsecretsecretse\00"
